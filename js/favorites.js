...
export class FavoritesView extends Favorites {
    ...
    creatRow() {
        ...
        tr.innerHTML = `
            <td class="user">
                <img src="https://github.com/AndrezaBarros.png" alt="Imagem do usuário">
                <a href="">
                    <p>Andreza Barros Tiezzi</p>
                    <span>/AndrezaBarros</span>
                </a>
            </td>
    ...
    addAlertEmptyTable() {
        let emptyTable = this.root.querySelector('.emptyTable')
        emptyTable.classList.remove('hide')
    }

    removeAlertEmptyTable() {
        let emptyTable = this.root.querySelector('.emptyTable')
